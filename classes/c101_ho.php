...
class c101_ho
{
	...
	// Table name
	public $TableName = 'c101_ho.php';

	// Page object name
	public $PageObjName = "c101_ho";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c101_ho.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c101_ho", $url, "", "c101_ho", TRUE);
		$this->Heading = $Language->TablePhrase("c101_ho", "TblCaption"); 
	}
} // End class
?>