 ...
 * Page class
 */
class t103_opname_delete extends t103_opname
{
	...
	// Page object name
	public $PageObjName = "t103_opname_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t103_opnamelist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t103_opnamelist.php"); // Return to list
			}
		}
	}
