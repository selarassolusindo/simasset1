 ...
 * Page class
 */
class t204_audittrail_delete extends t204_audittrail
{
	...
	// Page object name
	public $PageObjName = "t204_audittrail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t204_audittraillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t204_audittraillist.php"); // Return to list
			}
		}
	}
