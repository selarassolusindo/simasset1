 ...
 * Page class
 */
class t205_parameter_add extends t205_parameter
{
	...
	// Page object name
	public $PageObjName = "t205_parameter_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("t205_parameterlist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "t205_parameterlist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "t205_parameterview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->Parameter->CurrentValue = NULL;
		$this->Parameter->OldValue = $this->Parameter->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['Parameter'] = $this->Parameter->CurrentValue;
	...
	protected function validateForm()
	{
		...
		if ($this->Parameter->Required) {
			if (!$this->Parameter->IsDetailKey && $this->Parameter->FormValue != NULL && $this->Parameter->FormValue == "") {
				AddMessage($FormError, str_replace("%s", $this->Parameter->caption(), $this->Parameter->RequiredErrorMessage));
			}
		}
