 ...
 * Page class
 */
class userpriv extends t202_userlevels
{
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["t202_userlevels"]))
			$GLOBALS["t202_userlevels"] = &$this;
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 't202_userlevels');
			if ($Security->isLoggedIn())
		...
		$Breadcrumb->add("list", "t202_userlevels", "t202_userlevelslist.php", "", "t202_userlevels");
		...
		if (Post("action") == "") {
			...
			if (Get("userlevelid") !== NULL) {
				...
				$this->terminate("t202_userlevelslist.php"); // Return to list
			}
