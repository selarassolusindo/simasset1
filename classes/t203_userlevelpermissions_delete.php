 ...
 * Page class
 */
class t203_userlevelpermissions_delete extends t203_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t203_userlevelpermissions_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t203_userlevelpermissionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t203_userlevelpermissionslist.php"); // Return to list
			}
		}
	}
