 ...
 * Page class
 */
class t008_brand_delete extends t008_brand
{
	...
	// Page object name
	public $PageObjName = "t008_brand_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t008_brandlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t008_brandlist.php"); // Return to list
			}
		}
	}
