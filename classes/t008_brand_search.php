 ...
 * Page class
 */
class t008_brand_search extends t008_brand
{
	...
	// Page object name
	public $PageObjName = "t008_brand_search";
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "t008_brandlist.php" . "?" . $srchStr;
	...
	protected function buildAdvancedSearch()
	{
		...
		$this->buildSearchUrl($srchUrl, $this->Brand); // Brand
		if ($srchUrl != "")
			$srchUrl .= "&";
		$srchUrl .= "cmd=search";
		return $srchUrl;
	...
	protected function loadSearchValues()
	{
		...
		if ($this->id->AdvancedSearch->post())
			$got = TRUE;
		if ($this->Brand->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if (!$this->Brand->Raw)
				$this->Brand->AdvancedSearch->SearchValue = HtmlDecode($this->Brand->AdvancedSearch->SearchValue);
			$this->Brand->EditValue = HtmlEncode($this->Brand->AdvancedSearch->SearchValue);
