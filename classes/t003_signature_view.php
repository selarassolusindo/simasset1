 ...
 * Page class
 */
class t003_signature_view extends t003_signature
{
	...
	// Page object name
	public $PageObjName = "t003_signature_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t003_signaturelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t003_signaturelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t003_signaturelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
