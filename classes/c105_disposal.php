...
class c105_disposal
{
	...
	// Table name
	public $TableName = 'c105_disposal.php';

	// Page object name
	public $PageObjName = "c105_disposal";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c105_disposal.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c105_disposal", $url, "", "c105_disposal", TRUE);
		$this->Heading = $Language->TablePhrase("c105_disposal", "TblCaption"); 
	}
} // End class
?>