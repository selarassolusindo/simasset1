 ...
 * Page class
 */
class t001_property_view extends t001_property
{
	...
	// Page object name
	public $PageObjName = "t001_property_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t001_propertylist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t001_propertylist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t001_propertylist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
