...
class c9
{
	...
	// Table name
	public $TableName = 'c9.php';

	// Page object name
	public $PageObjName = "c9";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'c9.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "c9", $url, "", "c9", TRUE);
		$this->Heading = $Language->TablePhrase("c9", "TblCaption"); 
	}
} // End class
?>