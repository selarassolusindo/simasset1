 ...
 * Page class
 */
class t103_opname_edit extends t103_opname
{
	...
	// Page object name
	public $PageObjName = "t103_opname_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// OpnameDate
			$this->OpnameDate->setDbValueDef($rsnew, UnFormatDateTime($this->OpnameDate->CurrentValue, 0), CurrentDate(), $this->OpnameDate->ReadOnly);
			...
			// Actual
			$this->Actual->setDbValueDef($rsnew, $this->Actual->CurrentValue, 0, $this->Actual->ReadOnly);

			// OpnameQty
			$this->OpnameQty->setDbValueDef($rsnew, $this->OpnameQty->CurrentValue, 0, $this->OpnameQty->ReadOnly);

			// Diff
			$this->Diff->setDbValueDef($rsnew, $this->Diff->CurrentValue, 0, $this->Diff->ReadOnly);
