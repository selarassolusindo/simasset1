...
<?php if ($t202_userlevels_list->userlevelid->Visible) { // userlevelid ?>
	...
	<?php } else { ?>
		<th data-name="userlevelid" class="<?php echo $t202_userlevels_list->userlevelid->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t202_userlevels_list->SortUrl($t202_userlevels_list->userlevelid) ?>', 2);"><div id="elh_t202_userlevels_userlevelid" class="t202_userlevels_userlevelid">
...
<?php if ($t202_userlevels_list->userlevelname->Visible) { // userlevelname ?>
	...
	<?php } else { ?>
		<th data-name="userlevelname" class="<?php echo $t202_userlevels_list->userlevelname->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t202_userlevels_list->SortUrl($t202_userlevels_list->userlevelname) ?>', 2);"><div id="elh_t202_userlevels_userlevelname" class="t202_userlevels_userlevelname">
