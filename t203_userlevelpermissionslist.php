...
<?php if ($t203_userlevelpermissions_list->userlevelid->Visible) { // userlevelid ?>
	...
	<?php } else { ?>
		<th data-name="userlevelid" class="<?php echo $t203_userlevelpermissions_list->userlevelid->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t203_userlevelpermissions_list->SortUrl($t203_userlevelpermissions_list->userlevelid) ?>', 2);"><div id="elh_t203_userlevelpermissions_userlevelid" class="t203_userlevelpermissions_userlevelid">
...
<?php if ($t203_userlevelpermissions_list->_tablename->Visible) { // tablename ?>
	...
	<?php } else { ?>
		<th data-name="_tablename" class="<?php echo $t203_userlevelpermissions_list->_tablename->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t203_userlevelpermissions_list->SortUrl($t203_userlevelpermissions_list->_tablename) ?>', 2);"><div id="elh_t203_userlevelpermissions__tablename" class="t203_userlevelpermissions__tablename">
...
<?php if ($t203_userlevelpermissions_list->permission->Visible) { // permission ?>
	...
	<?php } else { ?>
		<th data-name="permission" class="<?php echo $t203_userlevelpermissions_list->permission->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t203_userlevelpermissions_list->SortUrl($t203_userlevelpermissions_list->permission) ?>', 2);"><div id="elh_t203_userlevelpermissions_permission" class="t203_userlevelpermissions_permission">
