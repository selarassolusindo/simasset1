...
<?php if ($t204_audittrail_list->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id" class="<?php echo $t204_audittrail_list->id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t204_audittrail_list->SortUrl($t204_audittrail_list->id) ?>', 2);"><div id="elh_t204_audittrail_id" class="t204_audittrail_id">
...
<?php if ($t204_audittrail_list->datetime->Visible) { // datetime ?>
	...
	<?php } else { ?>
		<th data-name="datetime" class="<?php echo $t204_audittrail_list->datetime->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t204_audittrail_list->SortUrl($t204_audittrail_list->datetime) ?>', 2);"><div id="elh_t204_audittrail_datetime" class="t204_audittrail_datetime">
...
<?php if ($t204_audittrail_list->script->Visible) { // script ?>
	...
	<?php } else { ?>
		<th data-name="script" class="<?php echo $t204_audittrail_list->script->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t204_audittrail_list->SortUrl($t204_audittrail_list->script) ?>', 2);"><div id="elh_t204_audittrail_script" class="t204_audittrail_script">
...
<?php if ($t204_audittrail_list->user->Visible) { // user ?>
	...
	<?php } else { ?>
		<th data-name="user" class="<?php echo $t204_audittrail_list->user->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t204_audittrail_list->SortUrl($t204_audittrail_list->user) ?>', 2);"><div id="elh_t204_audittrail_user" class="t204_audittrail_user">
...
<?php if ($t204_audittrail_list->_action->Visible) { // action ?>
	...
	<?php } else { ?>
		<th data-name="_action" class="<?php echo $t204_audittrail_list->_action->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t204_audittrail_list->SortUrl($t204_audittrail_list->_action) ?>', 2);"><div id="elh_t204_audittrail__action" class="t204_audittrail__action">
...
<?php if ($t204_audittrail_list->_table->Visible) { // table ?>
	...
	<?php } else { ?>
		<th data-name="_table" class="<?php echo $t204_audittrail_list->_table->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t204_audittrail_list->SortUrl($t204_audittrail_list->_table) ?>', 2);"><div id="elh_t204_audittrail__table" class="t204_audittrail__table">
...
<?php if ($t204_audittrail_list->field->Visible) { // field ?>
	...
	<?php } else { ?>
		<th data-name="field" class="<?php echo $t204_audittrail_list->field->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $t204_audittrail_list->SortUrl($t204_audittrail_list->field) ?>', 2);"><div id="elh_t204_audittrail_field" class="t204_audittrail_field">
